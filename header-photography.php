...
<body <?php body_class(); ?> onLoad="MM_preloadImages('http://www.thomaswicker.com/img/headerLogo_over.png','http://www.thomaswicker.com/btns/smNav_facebook_over.png','http://www.thomaswicker.com/btns/smNav_twitter_over.png','http://www.thomaswicker.com/btns/smNav_instagram_over.png','http://www.thomaswicker.com/btns/smNav_pinterest_over.png','http://www.thomaswicker.com/btns/smNav_linkedIn_over.png')">
		...
		<div id="navbarMainContainer" class="collapse navbar-collapse navbar-ex1-collapse nav navbar-nav">
	        ...
	        <div id="navBarLarge" class="visible-lg visible-md visible-sm ">
	              ...
	              <ul>
	                ...
	                <li id="homeBTN">
	                    <a href="http://thomaswicker.com" title="Home">
	                      <i class="fa fa-home"></i>
	                    </a>
	                </li>
	                
	                <li id="portfolioBTN">
	                    <a href="http://www.behance.net/thomaswicker" target="blank" title="My Portfolio">
	                      <i class="fa fa-behance"></i>
	                    </a>
	                </li>
	                
	                <li id="photographyBTNActive">
	                ...
	                <li id="resumeBTN">
	                     <a href="http://www.thomaswicker.com/resume" title="My Current Resume">
	                       <i class="fa fa-file-code-o"></i>
	                     </a>     
	                </li>                       
	                
	                <li id="contactBTN" >
	                    <a href="#" data-toggle="modal" data-target="#contactModal" title="Contact Me"/>
			...
			<ul id="navBarSmall" class="nav pull-right hidden-lg hidden-md hidden-sm visible-xs">
				...
				<li class="col-sm-12 col-xs-12"> 
					<a href="http://www.thomaswicker.com/photography" title="My Photography"><p class="navBarSmallActive">MY PHOTOGRAPHY</p></a>
				</li>
				...
				<li class="col-sm-12 col-xs-12">
					<a href="http://www.thomaswicker.com/contact" title="Contact Me"/><p>CONTACT ME</p></a>
				</li>
